...
and outputs normalized IOCs to dashboard/public/data/normalized_iocs.json
...
from utils.scraper import enrich_description
...
def main():
    ...
    parser.add_argument('--output', type=str, default='../../dashboard/public/data/normalized_iocs.json',
