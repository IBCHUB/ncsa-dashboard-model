    ...
    def __init__(self):
        ...
        self.index_docs = {
            ...
            self.datalake_index: {
                ...
                "dl-cve-1": {
                    "ioc_value": "CVE-2026-12345",
                    "ioc_type": "cve",
                    "description": "CISA KEV lists CVE-2026-12345 as actively exploited remote code execution.",
                    "reference": "https://thehackernews.example/cve-2026-12345",
                    "source_name": "TheHackerNews",
                    "source_type": "news",
                    "severity": "critical",
                    "threat_type": ["Malware"],
                    "event_time": "2026-03-11T05:10:00Z",
                    "collect_time": "2026-03-11T05:11:00Z",
                    "tlp": "amber",
                },
                "dl-4": {
                    "ioc_value": "suspicious-review.example",
